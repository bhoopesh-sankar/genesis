...
function Deliverymanlogin(props) {

    useEffect(() => {
        document.title = "DeliveryMan Login";
    }, []);
    ...
    async function connectWallet() {
        ...
        if (window.ethereum) {
            try {
                ...
                window.location.replace('/deliverymanHome');
            }
            catch (error) {
    ...
    return (
        <div>
            <div>
                <h1 style={{ paddingTop: '150px', paddingLeft: '635px', fontSize: '40px', fontWeight: 'bold', }}>DELIVERY MAN LOGIN</h1>
            </div>
            <br /><br /><br />
            ...
            <h1 style={{ paddingLeft: '630px', fontSize: '20px', fontWeight: 'bold', }}>Don't have an account. Click <a href='deliverymanRegister' style={{ color: 'blue', }}>here</a> to register</h1>
            <br />
            <div>
                {errorMessage()}
            </div>
