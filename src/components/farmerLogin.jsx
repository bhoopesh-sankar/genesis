...
function Farmerlogin() {
    ...
    async function connectWallet() {
        ...
        if (window.ethereum) {
            ...
            try {
                ...
                window.location.replace('/farmerHome');
            }
            catch (error) {
    ...
    return (
        <div>
            <div>
                <h1 style={{ paddingTop: '150px', paddingLeft: '700px', fontSize: '40px', fontWeight: 'bold',}}>FARMER LOGIN</h1>
            </div>
            <br /><br /><br />
            ...
            <h1 style={{ paddingLeft: '630px', fontSize: '20px', fontWeight: 'bold', }}>Don't have an account. Click <a href='farmerRegister' style={{ color: 'blue', }}>here</a> to register</h1>
            <br />
            <div>
                {errorMessage()}
            </div>
